...
then
  MYSQL_COMMANDS="$MYSQL_COMMANDS; REVOKE ALL PRIVILEGES ON $OPUS4_DB_NAME.* FROM $OPUS4_DB_USER@'localhost'; DROP USER $OPUS4_DB_USER;"
fi
...
then
  MYSQL_COMMANDS="$MYSQL_COMMANDS; REVOKE ALL PRIVILEGES ON $OPUS4_DB_NAME.* FROM $OPUS4_DB_ADMIN@'localhost'; DROP USER $OPUS4_DB_ADMIN;"
fi
